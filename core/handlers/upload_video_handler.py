...
async def send_video_handler(bot, cmd, output_vid, video_thumbnail, duration, width, height, editable, logs_msg, file_size):
    ...
    sent_vid = await bot.send_video(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/GreyMatter_Owner")],
                                           [InlineKeyboardButton("Bots Channel", url="https://t.me/GreyMatters_Bot")],
