...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/GreyMatter_Owner"), InlineKeyboardButton("Support Group", url="https://t.me/greymatters_bots_discussion")], [InlineKeyboardButton("Bots Channel", url="https://t.me/GreyMatters_Bot")], [InlineKeyboardButton("Source Code", url="https://github.com/GreyMattersBot/Watermark-Bot")]]),
...
async def VidWatermarkAdder(bot, cmd):
	...
	if (int(file_size) > 2097152000) and (Config.ALLOW_UPLOAD_TO_STREAMTAPE is True) and (Config.STREAMTAPE_API_USERNAME != "NoNeed") and (Config.STREAMTAPE_API_PASS != "NoNeed"):
		...
		try:
			...
			print(f"Error: {e}")
			await editable.edit("Sorry, Something went wrong!\n\nCan't Upload to Streamtape. You can report at [Support Group](https://t.me/greymatters_bots_discussion).")
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/GreyMatter_Owner"), InlineKeyboardButton("Support Group", url="https://t.me/greymatters_bots_discussion")], [InlineKeyboardButton("Bots Channel", url="https://t.me/GreyMatters_Bot")]]),
			disable_web_page_preview=True
		)
